    ...
    >
      <div className="app-splash__center">
        ...
        <p className="app-splash__slogan">
          ...
          <span className="app-splash__slogan-part app-splash__slogan-part--cyan app-splash__slogan-part--2">
            {t("hero.sloganGame")}.
          </span>{" "}
          <span className="app-splash__slogan-part app-splash__slogan-part--gold app-splash__slogan-part--3">
